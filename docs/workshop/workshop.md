...
6.  The key pair will be generated and saved in the .ssh directory
    within your home directory. The private key will be saved as id_rsa
...
8.  Click on Settings and select SSH and GPG Keys on left:
    ...
    ![A screenshot of a phone Description automatically generated](./media/image11.png)

    ![A screenshot of a computer Description automatically generated](./media/image12.png)

9.  Click on New SSH Key button:

    ![A white background with blue text Description automatically generated](./media/image13.png)
...
3.  Change your current directory to the jqport directory:
    ...
    ZOPEN_STABLE_DEPS: are used to identify the non-standard zopen community dependencies needed to build the project.
...
4.  Here is an example implementation of zopen_check_results():
...
5.  We get the following error:
    ...
    ![A screenshot of a computer screen Description automatically generated](./media/image15.png)
