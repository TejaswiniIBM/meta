...
mode for overriding z/OS <i>/bin</i> tools in the
...
<i>/usr/local/zopen</i> (default), zopen: <i>/usr/zopen</i>,
prod: legacy zopen standard location, ibm: <i>/usr/lpp</i>,
fhs: File Hierarchical Standard (<i>/opt</i>), usrlcl:
usr/local</p>
